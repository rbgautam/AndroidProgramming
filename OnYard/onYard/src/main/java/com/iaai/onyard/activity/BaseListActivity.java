...
import com.iaai.onyard.dialog.ProgressDialogFragment2;
...
public abstract class BaseListActivity extends ListActivity implements GetPendingCountListener {

    private boolean mLoggedInAtPause = false;
    private ProgressDialogFragment2 mProgressDialog;
    ...
    protected void showProgressDialog() {
        ...
        mProgressDialog = new ProgressDialogFragment2();
        mProgressDialog.show(getFragmentManager(), FragmentTag.PROGRESS_DIALOG);
    }
